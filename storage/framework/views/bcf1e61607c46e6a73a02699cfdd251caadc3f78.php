...
<div class="header parallax">
    <div id="main-menu" class="sticky">
        <div class="container">
            <div class="row">
                <div class="col-xs-3">
                    <h1><a target="_blank" href="<?php echo e(url('intro')); ?>"><img src="<?php echo e(url('images')); ?>/logo.svg"
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a target="_blank" href="<?php echo e(config('landing.item_url')); ?>" class="dropdown-item btn-buynow">BUY NOW</a></li>
                        </div>
                    </div>
                    <ul class="menu">
                        <li>
                            <a target="_blank" href="<?php echo e(config('landing.item_url')); ?>" class="btn-buynow">BUY NOW</a></li>
            ...
            <div class="row">
                <?php $__currentLoopData = config('landing.exclusive_features'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-6 col-md-6">
                        <div class="item">
                            <img src="<?php echo e(url('landing')); ?>/<?php echo e($feature['thumb']); ?>" alt="Plugin"/>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        ...
        <a target="_blank"  href="<?php echo e(config('landing.item_url')); ?>" class="btn-buynow">BUY NOW</a>
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
...
<?php /**PATH C:\laragon\www\findhouse\resources\views/landing/index.blade.php ENDPATH**/ ?>