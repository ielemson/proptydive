		...
		<div class="container-fluid p0">
		    ...
		    <nav>
				...
				<a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="navbar_brand float-left dn-smd">
					<?php if((isset($is_homepage) && $is_homepage == true)): ?>
						<?php if($logo_id_tran = setting_item("logo_id_tran")): ?>
							...
							<img class="logo1 img-fluid" src="<?php echo e($logo_tran); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
						<?php endif; ?>
					<?php else: ?>
						<?php if($logo_id = setting_item("logo_id")): ?>
							<?php $logo = get_file_url($logo_id,'full') ?>
							<img class="logo1 img-fluid" src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
						<?php endif; ?>
					<?php endif; ?>
		            <?php if($logo_id = setting_item("logo_id")): ?>
                        <?php $logo = get_file_url($logo_id,'full') ?>
                        <img class="logo2 img-fluid" src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
					<?php endif; ?>
					<span><?php echo e(setting_item("site_title")); ?></span>
		        </a>
                ...
                <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
					...
					<?php endif; ?>
					<?php if(!Auth::check() or Auth::user()->hasPermission('dashboard_agent_access')): ?>
						<?php if(Auth::id() and Auth::user()->hasPermission('dashboard_access')): ?>
							<li class="list-inline-item add_listing"><a href="<?php echo e(route("property.vendor.create")); ?>"><span class="flaticon-plus"></span><span class="dn-lg"> <?php echo e(__('Create Listing')); ?></span></a></li>

						<?php else: ?>
						<li class="list-inline-item add_listing"><a href="<?php echo e(url('/user/property/create')); ?>"><span class="flaticon-plus"></span><span class="dn-lg"> <?php echo e(__('Create Listing')); ?></span></a></li>
						<?php endif; ?>
					<?php endif; ?>
                </ul>
		    </nav>
			...
			<div class="header stylehome1">
				<div class="main_logo_home2 text-center" onclick="window.location.href='<?php echo e(asset('/')); ?>'">
						...
						<?php if($logo_id = setting_item("logo_id_mb")): ?>
							<?php $logo = get_file_url($logo_id,'full') ?>
							<img class="nav_logo_img img-fluid mt20" src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
		...
		<nav id="menu" class="stylehome1 mm-menu_offcanvas">
			<ul>
				...
				<?php if(!Auth::id()): ?>
                    ...
                    <?php endif; ?>
				<?php endif; ?>
					<li><?php echo $__env->make('Core::frontend.currency-switcher',['mobile'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></li>
...
<?php /**PATH C:\laragon\www\findhouse\themes/Findhouse/Layout/parts/header.blade.php ENDPATH**/ ?>